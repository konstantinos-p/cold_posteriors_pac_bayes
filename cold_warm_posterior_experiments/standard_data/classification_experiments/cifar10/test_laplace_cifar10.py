...
'''
In this script we test the K-FAC Laplace approximation for the cifar10 dataset.
...
test_dataloader,train_dataloader,validation_dataloader = get_dataloaders(dir=dir_CIFAR10)
