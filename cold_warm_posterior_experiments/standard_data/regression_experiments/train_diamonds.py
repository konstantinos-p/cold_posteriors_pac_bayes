...
'''
This script trains multiple neural networks on the Diamonds dataset and saves them in new folders in the current directory.
'''
...
for i in range(number_of_networks):
    ...
    model = NeuralNetwork(input_size=9)
    model.to(device)
