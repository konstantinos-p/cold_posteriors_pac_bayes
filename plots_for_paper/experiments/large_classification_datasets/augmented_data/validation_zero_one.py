...
f, axs = plt.subplots(2,1,figsize = (6, 5.5))
...
path = '/Users/Kostas/PycharmProjects/cold-warm-posteriors/cold_warm_posterior_experiments/augmented_data/' \
       'classification_experiments/cifar10/results/runs/wrong_results_validation/isotropic/'

models = [0,2,4,5,6,9,7]
...
a = np.argmin(test_means)
#Subfigure 10
path = '/Users/Kostas/PycharmProjects/cold-warm-posteriors/cold_warm_posterior_experiments/augmented_data/' \
       'classification_experiments/cifar10/results/runs/wrong_results_validation/kron/'

models = [0,4,6,7]#[0,3,4,6,7]
...
#Subfigure 01
path = '/Users/Kostas/PycharmProjects/cold-warm-posteriors/cold_warm_posterior_experiments/augmented_data/' \
       'classification_experiments/cifar100/results/runs/wrong_results_validation/isotropic/'
...
#Subfigure 11
path = '/Users/Kostas/PycharmProjects/cold-warm-posteriors/cold_warm_posterior_experiments/augmented_data/' \
       'classification_experiments/cifar100/results/runs/wrong_results_validation/kron/'
