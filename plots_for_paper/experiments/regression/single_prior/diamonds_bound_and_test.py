...
"""
Plot for the Diamonds dataset original bounds for Figure 3 of the paper.
"""
def scale01(x):
    return x/np.max(x)
...
plt.title('DIAMONDS',fontsize=size_font_title)
ax1.vlines(1, 0.925,
           0.95, linewidth=5, linestyle='--',
           zorder=-1, alpha=0.5)
# Figure formating
...
plt.savefig('diamonds_alquier.png',dpi=300)
