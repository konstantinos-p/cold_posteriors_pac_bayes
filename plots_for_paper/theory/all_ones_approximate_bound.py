...
'''
Corollary 1 approximate bound, Figure 2.a in the main text.
'''
...
#values for lambda
tolerance = 0.05
lambdas = np.linspace(0+tolerance,1/2-tolerance,1000)

#Calculate terms
Empicical_Risk = emp_risk(lambdas)
Moment = moment(lambdas)
KL = kl(lambdas)
