...
'''
KC_House approximate bound, Figure 3 Appendix.
'''


#Load data
path = '/Users/Kostas/PycharmProjects/cold-warm-posteriors/cold_warm_posterior_experiments/standard_data/' \
       'regression_experiments/kc_house/results/kc_house_lambda_0_to_10/model_0/'
...
plt.savefig('kc_house_approximate.png',dpi=300)
end = 1