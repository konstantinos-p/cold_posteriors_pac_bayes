...
'''
Diamonds mixed bound, Figure 3 Appendix.
'''
...
#Calculate terms
Empicical_Risk = contents['empirical_risk']
...
patch3 = Line2D([0], [0], marker='s', color='w', label=r'$\mathcal{B}_{\mathrm{mixed}}$',
