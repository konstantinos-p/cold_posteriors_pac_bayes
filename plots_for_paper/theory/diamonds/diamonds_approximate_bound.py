...
'''
Diamonds approximate bound, Figure 3 Appendix.
'''


#Load data
path = '/Users/Kostas/PycharmProjects/cold-warm-posteriors/cold_warm_posterior_experiments/standard_data/' \
       'regression_experiments/diamonds/results/diamonds_lambda_0_to_10/model_0/'

log_file_1 = open(path+"bound_log_5.pkl", "rb")
...
#Calculate terms
Empicical_Risk = contents['empirical_risk'][1:-1]
Moment = contents['moment']
KL = contents['kl'][1:-1]

lambdas = output1['approximate'][0]
...
patch3 = Line2D([0], [0], marker='s', color='w', label=r'$\mathcal{B}_{\mathrm{approximate}}$',
...
plt.savefig('diamonds_approximate.png',dpi=300)
end = 1